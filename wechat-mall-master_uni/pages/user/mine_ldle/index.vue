		...
		<view class="cu-list goods">
			<view class="cu-item bg-white" v-for="(item, index) in list" :key="item.id">
				<navigator :url="'../../goods/detail/index?id=' + item.id">
					<view class="cu-avatar photo radius lg" :style="'background-image:url(' + item.img_md + ');'">
					</view>
				</navigator>
				<view class="content">
					...
					<view class="flex align-end">
						...
						<view class="action text-xl flex align-center">
						    <navigator class="margin-lr-lg" :url="'../../add_detail/ldle/edit_ldle?id=' + item.id">
