<template>
	<block>
		<view class="cu-list goods">
			<view class="cu-item bg-white" v-for="(item, index) in data" :key="item.id">
				<navigator class="content" :url="'../../cart/detail?id=' + item.id">
				...
				<view class="flex align-end">
					<view class="action text-xl flex align-center">
					    <navigator class="margin-lr-lg" :url="'../../add_detail/runner/runner?id=' + item.id">
