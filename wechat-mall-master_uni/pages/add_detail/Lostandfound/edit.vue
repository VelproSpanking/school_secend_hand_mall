		...
		<view class="uni-padding-wrap uni-common-mt">
			<form @submit="formSubmit" @reset="formReset">
				...
				<view class="uni-form-item uni-column">
					...
					<uni-section title="请输入物品丢失时间" type="line" name="lost_time" :value="form.lost_time" ></uni-section>
				...
				<view class="uni-form-item uni-column">
					...
					<input class="uni-input" name="wechat"  :value="form.wechat" placeholder="输入联系人的微信号" />
				</view>
		...
		methods: {
            ...
            async loadDetail(id) {
            	let {
            		status,
            		list
            	} = await lostandfounds.detail({
            		id
            	});
            	if (status) {
            		this.setData({
            			form: list,
						single1:list.lost_time
