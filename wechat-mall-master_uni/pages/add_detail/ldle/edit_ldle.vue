		...
		<view class="uni-padding-wrap uni-common-mt">
			<form enctype="multipart/form-data" @submit="formSubmit" @reset="formReset">
				...
				<view class="uni-form-item uni-column">
					...
					<input class="uni-input" name="price" :value="form.price" placeholder="输入宝贝卖价" />
				</view>
				<view class="uni-form-item uni-column">
					<view class="title">原价</view>
					<input class="uni-input" name="marketPrice" :value="form.marketPrice" placeholder="输入宝贝原价(大致价格)(元)" />
				</view>
				<view class="uni-form-item uni-column">
				...
				<view class="uni-form-item uni-column">
					...
					<input class="uni-input" name="telphone"  :value="form.telphone" placeholder="输入您的手机号" />
				</view>
				<view class="uni-form-item uni-column">
				...
				<view class="uni-form-item uni-column">
					<view class="imageA">
						...
						<image v-for="(item,index) in imgArr" :src="imgArr" name="imgArr" :value="imgArr"
