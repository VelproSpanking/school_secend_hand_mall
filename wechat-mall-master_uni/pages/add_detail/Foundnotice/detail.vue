<template>
    ...
    <view>
		...
		<view class="goods-card padding-lg bg-white">
		   <view class="text-black text-lg padding-bottom-lg"> 丢失物品名称:{{ goods.name }}</view>
		<!-- </view>
		<view class="goods-card padding-lg bg-white"> -->
		    <view class="text-black text-lg padding-bottom-lg">丢失物品地点:{{ goods.address }}</view>
		<!-- </view>
		<view class="goods-card padding-lg bg-white"> -->
			    <view class="text-black text-lg padding-bottom-lg">丢失物品时间：{{ goods.time }}</view>
		<!-- </view>
		<view class="goods-card padding-lg bg-white"> -->
...
import { noticefounds } from '../../../api/index.js';
export default {
    data() {
        return {
            id: 0,
    ...
    methods: {
      ...
      openWechat(goods){
        ...
        async loadDetail() {
            let { id } = this;
            let { status, list } = await noticefounds.detail({
                id
            });
