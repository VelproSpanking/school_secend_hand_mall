  ...
  <div>
    <el-card class="box-card">
      ...
      <el-table :data="tableData" style="width:100%">
        ...
        <el-table-column sortable prop="address" label="拾到地址">
        </el-table-column>
        <el-table-column sortable prop="person_wechat" label="微信">
        </el-table-column>
        <el-table-column sortable prop="person_connect" label="联系方式">
        </el-table-column>
        <el-table-column sortable prop="time" label="拾到时间">
        </el-table-column>
...
<script>
import { foundnotice } from '@/api/index';
...
export default {
  ...
  methods: {
    async loadGoodsList() {
      let { status, list, total } = await foundnotice.list({
