  ...
  <div>
    <el-card class="box-card">
      ...
      <el-table :data="tableData" style="width:100%">
                <el-table-column fixed label="物品名称" width="100" height="200">
        ...
        <el-table-column sortable prop="address" label="丢失地址">
        </el-table-column>
        <el-table-column sortable prop="person_wechat" label="微信">
        </el-table-column>
        <el-table-column sortable prop="person_connect" label="物主名称">
        </el-table-column>
        <el-table-column sortable prop="time" label="丢失时间">
        </el-table-column>
        <el-table-column sortable prop="create_time" label="创建时间">
        </el-table-column>
        <el-table-column sortable prop="create_name" label="创建人">
        </el-table-column>
...
<script>
import { lostandfound } from '@/api/index';
...
export default {
  ...
  methods: {
    async loadGoodsList() {
      let { status, list, total } = await lostandfound.list({
