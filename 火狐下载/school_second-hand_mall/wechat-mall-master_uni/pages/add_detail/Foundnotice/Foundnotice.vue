		...
		<view class="uni-padding-wrap uni-common-mt">
			<form @submit="formSubmit" @reset="formReset">
				<view class="uni-form-item uni-column">
					...
					<input class="uni-input" name="name" placeholder="输入丢失物品名称" />
				</view>
				<view class="uni-form-item uni-column">
					<view class="title">丢失物品地点</view>
					<input class="uni-input" name="address" placeholder="输入丢失物品地点" />
				</view>
				<view class="uni-form-item uni-column">
				...
				<view class="uni-form-item uni-column">
					...
					<uni-section title="请输入物品丢失时间" type="line" name="time" :value="time" ></uni-section>
				...
				<view class="uni-form-item uni-column">
					...
					<input class="uni-input" name="person_wechat" placeholder="输入联系人的微信号" />
				</view>
		...
		methods: {
			...
			formSubmit: function(e) { 
                ...
                var rule = [
					...
					{name:"person_wechat", checkType : "notnull", checkRule:"0",  errorMsg:"输入您的微信号"},
				...
				for (let i = 0; i < that.imgArr.length; i++) {
					uni.uploadFile({
						url: "http://127.0.0.1:3003/api/foundnotice", //仅为示例，非真实的接口地址
